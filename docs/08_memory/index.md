...
3. [SRAM vs DRAM vs HBM：Cell、距离与接口](sram_dram_hbm.md)
4. [Roofline Model：把算力、带宽与 workload 放到同一张图](roofline_model.md)
5. [HBM：为什么 AI 加速器必须把 DRAM 堆到封装旁边](../09_hbm/hbm.md)
6. 下一步：memory controller、virtual memory 与 memory pooling。
