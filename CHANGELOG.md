...
- 新增六卷工程术语计算、测量与故障案例手册，把结构化 glossary 的 233 个术语转化为可执行的性能计算、测量计划、压力测试、恢复验收、证伪条件与战略传导工作单。
- 新增截至 2026-08-28 的 AI 基础设施行业动态报告，以官方材料核验加速器平台、HBM4、先进封装、PCIe 7.0、CXL 4.0、UCIe 3.0、UEC 1.0、CPO、液冷和软件栈状态。
- 正文规模达到 103 篇、579,339 个 Han characters；全部 docs 为 584,822 个 Han characters。
- CI body-only content floor 从 300,000 提升至 500,000，并把正文篇数下限提升至 103。

- 结构化 glossary 从 114 个扩展至 233 个术语，并新增涵盖微架构、GPU、DRAM、I/O、SerDes、网络、光学、电源、散热、封装、制造、软件、运维、产品状态与战略的进阶手册。
- 扩写前的 95 篇正文全部加入模块专属进阶术语桥接；正文总量达到 96 篇、306,410 个 Han characters。
- CI body-only content floor 从 200,000 提升至 300,000，继续排除 index 与模板，避免以导航文本满足门槛。
